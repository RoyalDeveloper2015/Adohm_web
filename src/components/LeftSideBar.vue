        ...
        <ul class="side-nav color-gray">
          ...
          <li class="has-children">
            ...
            <ul class="child-nav">
              ...
              <li><a href="dashboard-full-width.html"><i class="fa fa-dashboard"></i> <span>Layout 3</span></a>
              </li>
            </ul>
          </li>
          ...
          <li class="has-children">
            <a href="#"><i class="fa fa-file-text"></i> <span>Page Layouts</span> <i
              class="fa fa-angle-right arrow"></i></a>
            <ul class="child-nav">
              ...
              <li><a href="layout-fixed-top-side.html"><i class="fa fa-thumb-tack"></i>
                <span>Fixed Top & Sidebar</span></a></li>
              <li><a href="layout-static-top-side.html"><i class="fa fa-unlock"></i>
                <span>Static Top & Sidebar</span></a></li>
              <li><a href="layout-small-sidebar.html"><i class="fa fa-sign-in"></i> <span>Small Sidebar</span></a>
              </li>
            </ul>
          </li>
          <li class="has-children">
            <a href="#"><i class="fa fa-paint-brush"></i> <span>Color Schemes</span> <i
              class="fa fa-angle-right arrow"></i></a>
            <ul class="child-nav">
          ...
          <li class="has-children">
            <a href="#"><i class="fa fa-map-signs"></i> <span>Sidebar Layouts</span> <i
              class="fa fa-angle-right arrow"></i></a>
            <ul class="child-nav">
              <li><a href="sidebar-light.html"><i class="fa fa-newspaper-o "></i> <span>Light Sidebar</span></a>
              </li>
              ...
              <li><a href="sidebar-danger.html"><i class="fa fa-info"></i> <span>Danger Sidebar</span></a></li>
              <li><a href="sidebar-success.html"><i class="fa fa-male"></i> <span>Success Sidebar</span></a></li>
              <li><a href="sidebar-warning.html"><i class="fa fa-sign-in"></i> <span>Warning Sidebar</span></a>
              </li>
            </ul>
          </li>
          ...
          <li class="has-children">
            <a href="#"><i class="fa fa-magic"></i> <span>UI Components</span> <span
              class="label label-success ml-5">Hot</span> <i class="fa fa-angle-right arrow"></i></a>
            <ul class="child-nav">
              ...
              <li><a href="ui-dropdown-menu.html"><i class="fa fa-sitemap"></i> <span>Dropdown Menu</span></a>
              </li>
              ...
              <li><a href="ui-timeout-session.html"><i class="fa fa-suitcase"></i>
                <span>Timeout Session</span></a>
              </li>
              <li><a href="index.html"><i class="fa fa-fighter-jet"></i> <span>Bootstrap Tour</span></a></li>
              <li><a href="ui-timeline.html"><i class="fa fa-clock-o"></i> <span>Timeline</span></a></li>
            </ul>
          </li>
          <li class="has-children">
            <a href="#"><i class="fa fa-bars"></i> <span>Bootstrap Components</span> <i
              class="fa fa-angle-right arrow"></i></a>
            <ul class="child-nav">
              ...
              <li><a href="bt-button-dropdown.html"><i class="fa fa-bookmark"></i>
                <span>Button Dropdown</span></a>
              </li>
              ...
              <li><a href="bt-labels-badges.html"><i class="fa fa-signal"></i> <span>Labels & Badges</span></a>
              </li>
          ...
          <li class="has-children">
            <a href="#"><i class="fa fa-comments-o"></i> <span>Tables</span> <i
              class="fa fa-angle-right arrow"></i></a>
            <ul class="child-nav">
              ...
              <li><a href="table-user-details.html"><i class="fa fa-table"></i>
                <span>Tabular User Details</span></a></li>
            </ul>
          </li>
          <li class="nav-header">
          ...
          <li class="has-children">
            <a href="#"><i class="fa fa-bar-chart-o"></i> <span>Amcharts</span> <i
              class="fa fa-angle-right arrow"></i></a>
            <ul class="child-nav">
              <li><a href="chart-column-bar.html"><i class="fa fa-barcode"></i>
                <span>Column & Bar Charts</span></a>
              </li>
              <li><a href="chart-line-area.html"><i class="fa fa-line-chart"></i>
                <span>Line & Area Charts</span></a></li>
          ...
          <li class=""><a href="form-validations.html"><i class="fa fa-info"></i> <span>Validations</span></a>
          </li>
          <li class="has-children">
            <a href="#"><i class="fa fa-bar-chart-o"></i> <span>Form Components</span> <i
              class="fa fa-angle-right arrow"></i></a>
            <ul class="child-nav">
              <li class=""><a href="form-checkbox.html"><i class="fa fa-check"></i> <span>Checkboxes</span></a>
              </li>
              <li class=""><a href="form-bt-switches.html"><i class="fa fa-bullhorn"></i>
                <span>Bootstrap Switch</span></a></li>
              <li class=""><a href="form-input-groups.html"><i class="fa fa-bullseye"></i>
                <span>Input Groups</span></a>
              </li>
              <li class=""><a href="form-select2.html"><i class="fa fa-arrows-alt"></i> <span>Select 2</span></a>
              </li>
              <li class=""><a href="form-switches.html"><i class="fa fa-check-square-o"></i>
                <span>Switches</span></a></li>
              <li class=""><a href="form-tags.html"><i class="fa fa-history"></i> <span>Tags</span></a></li>
            </ul>
          </li>
          <li class=""><a href="form-editable.html"><i class="fa fa-pencil"></i> <span>Editable Form</span></a>
          </li>
          ...
          <li class="has-children">
            <a href="#"><i class="fa fa-paperclip"></i> <span>Editors</span> <i
              class="fa fa-angle-right arrow"></i></a>
            <ul class="child-nav">
              <li class=""><a href="form-editor-ckeditor.html"><i class="fa fa-check"></i>
                <span>CKEditor</span></a>
              </li>
              <li class=""><a href="form-editor-summernote.html"><i class="fa fa-bullhorn"></i>
                <span>Summernote</span></a></li>
            </ul>
          </li>
          ...
          <li class="has-children">
            <a href="#"><i class="fa fa-sign-out"></i> <span>Register</span> <i
              class="fa fa-angle-right arrow"></i></a>
            <ul class="child-nav">
          ...
          <li class="has-children">
            <a href="#"><i class="fa fa-lock"></i> <span>Ecommerce</span> <i
              class="fa fa-angle-right arrow"></i></a>
            <ul class="child-nav">
              ...
              <li><a href="ecommerce-order-view.html"><i class="fa fa-sign-out"></i> <span>Order View</span></a>
              </li>
          ...
          <li class=""><a href="pages-error-500.html"><i class="fa fa-info-circle"></i> <span>Error 500</span></a>
          </li>
          <li class=""><a href="pages-profile.html"><i class="fa fa-user"></i> <span>Profile</span></a></li>
          <li class=""><a href="pages-pricing.html"><i class="fa fa-user-secret"></i> <span>Pricing</span></a>
          </li>
        </ul>
        <!-- /.side-nav -->
        <div class="purchase-btn hidden-sm hidden-xs">
          <a
            href="https://themeforest.net/item/options-admin-responsive-web-application-ui-kit/19796742?license=regular&open_purchase_for_item_id=19796742&purchasable=source&ref=salttechno"
            target="_blank" class="btn btn-success btn-labeled">Purchase Now<span
